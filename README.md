...
- Reverse proxies & cybersecurity basics
- Self-hosting & homelab setups (K3s, Proxmox, Jenkins)
...
>  Fun fact: I self-host my entire development environment — from Git to CI/CD to Kubernetes.
